...
public class ConnectionFactoryBuilder {
  ...
  public static void connectionFactoryBuilder(ApplicationContext ctx, String host, Integer port,
      String username, String password) {
    // 获取BeanFactory
    DefaultListableBeanFactory defaultListableBeanFactory =(DefaultListableBeanFactory) ctx.getAutowireCapableBeanFactory();
    // 创建connectionFactory信息
    BeanDefinitionBuilder connectionFactoryBuilder =BeanDefinitionBuilder.genericBeanDefinition(CachingConnectionFactory.class);
    ...
    defaultListableBeanFactory.registerBeanDefinition("connectionFactory",connectionFactoryBuilder.getBeanDefinition());
  }
}
